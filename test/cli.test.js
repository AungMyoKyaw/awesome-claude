...
`;
    ...
    assert(fileContent.includes('Test Claude Configuration'), 'Content should match');
...
describe('Configuration Validation', () => {
  test('should validate CLAUDE.md content', async () => {
    ...
    assert(content.includes('# Claude Configuration'), 'Should have main header');
    assert(content.includes('## Core Instructions'), 'Should have core instructions');
    assert(content.includes('## Work Style Preferences'), 'Should have work style preferences');
