...
This is the main configuration file for Claude AI assistant. It contains instructions and preferences for how Claude should behave and interact.

## Work Style Preferences

Claude should be helpful, clear, and professional in all interactions.
